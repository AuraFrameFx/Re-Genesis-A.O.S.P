...
plugins {
    id("genesis.android.application") version libs.versions.agp
    // alias(libs.plugins.ksp) // Temporarily removed for isolation
    alias(libs.plugins.kotlin.compose)
    id("org.jetbrains.kotlin.plugin.serialization") version "2.2.20"
    id("org.openapi.generator") version libs.versions.openapiGeneratorGradlePlugin
}

// Compose compiler configuration for AGP 9.x and Kotlin 2.2.x
...
tasks.openApiGenerate {
    ...
    inputSpec.set("file:///C:/ReGenesis/app/api/system-api.yml")
